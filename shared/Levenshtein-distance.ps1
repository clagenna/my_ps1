...
# the script accepts
###########
function levenstein-distance([string] $first, [string] $second, [switch] $ignoreCase) {
...
# $len = levenstein-distance "CENTRO INTERDIP. SERVIZIO INGEGNERISTICI E INFORMATICI" "CENTRO INTERDIP. SERVIZI INGEGNERISTICI ED INFORMATICI"
# Write-Host $len
