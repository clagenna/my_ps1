        ...
        switch ($PSCmdlet.ParameterSetName) {
            SingleSearchString {
                $NoSwitchesSpecified = -not (
                    $PSBoundParameters.ContainsKey("KeyName") `
                -or $PSBoundParameters.ContainsKey("ValueName") `
                -or $PSBoundParameters.ContainsKey("ValueData"))
...
$retVal = Search-Registry -Path "HKLM:\SOFTWARE\Microsoft\Microsoft SQL Server\*" -SearchRegex "SQLDataRoot" -KeyName -Recurse
